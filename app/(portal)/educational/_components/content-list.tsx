// app/(portal)/educational/_components/content-list.tsx
"use client";
...
interface ContentListProps {
  ...
  currentContentId?: string; // Adicionar esta prop
}

export function ContentList({ modules, currentContentId }: ContentListProps) {
